...
|---|---|---|
| **Web App** | HTMX + Jinja2 + Leaflet — consola del operador construida (ADR-0022) | UI servida desde el mismo proceso FastAPI. Sin SPA |
...
```mermaid
flowchart TB
    subgraph Cliente["Cliente (CLI o Navegador)"]
        UI["CLI / Web App"]
    end
